...
(1, 'iPhone X', 'Apple iPhone X (iPhone 10), 64GB storage, 5.8" Super Retina OLED display, A11 Bionic chip, Face ID, dual 12MP cameras, wireless charging, excellent condition, iconic design', 'Phones', 5800.00, '../assets/images/10.png', 'used', 'active'),
...
(1, 'Wireless Charger', 'Fast wireless charging pad, Qi-certified, 15W output, compatible with iPhone, Samsung, and all Qi-enabled devices, LED indicator, non-slip surface', 'Chargers', 350.00, '../assets/images/wireless.png', 'new', 'active'),
...
(1, 'Wireless Mouse', '2.4GHz wireless mouse with ergonomic design, adjustable DPI settings, silent click buttons, long battery life up to 18 months, USB nano receiver, compatible with Windows, Mac, and Linux', 'Accessories', 150.00, '../assets/images/muse.jpg', 'new', 'active'),
(1, 'USB Laptop Speakers', 'Portable USB-powered stereo speakers, crystal clear sound quality, compact design, volume control knob, 3.5mm audio jack, perfect for laptops, desktops, and tablets, plug-and-play', 'Accessories', 280.00, '../assets/images/spesker.png', 'new', 'active'),
...
(1, 'Cabled Earbuds', 'Premium cabled earbuds with superior sound quality, ergonomic fit, noise cancellation, inline remote control, built-in microphone, durable braided cable, 3.5mm jack, perfect for music lovers and students', 'Accessories', 180.00, '../assets/images/bug1.png', 'new', 'active'),
(1, 'External Hard Drive', 'Portable external hard drive, USB 3.0 high-speed transfer, compact and lightweight design, plug-and-play, compatible with Windows, Mac, and Linux, perfect for backup and extra storage, available in multiple capacities', 'Storage', 850.00, '../assets/images/hard.png', 'new', 'active'),
(1, 'RAM Module', 'High-performance RAM module for laptops and desktops, DDR4 technology, multiple speeds available (2400MHz, 2666MHz, 3200MHz), all sizes available (4GB, 8GB, 16GB, 32GB), easy installation, compatible with most systems, improves multitasking and performance', 'RAM', 650.00, '../assets/images/ram.png', 'new', 'active'),
(1, 'Power Cable', 'Universal power cable, 1.5 meters length, heavy duty construction, compatible with laptops, monitors, and desktop computers, 3-pin plug, durable and reliable', 'Cables', 80.00, '../assets/images/power.png', 'new', 'active'),
(1, 'Multi Adapter', 'Universal multi adapter with 4 USB ports and 3 AC outlets, surge protection, compact design, perfect for charging multiple devices simultaneously, ideal for students and travelers', 'Adapters', 320.00, '../assets/images/adapter.png', 'new', 'active')
